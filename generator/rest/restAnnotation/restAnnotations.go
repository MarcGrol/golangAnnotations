...
func Register() {
	annotation.RegisterAnnotation(TypeRestOperation, []string{ParamPath, ParamMethod, ParamForm, ParamFormat, ParamFilename, ParamOptional, ParamRoles}, validateRestOperationAnnotation)

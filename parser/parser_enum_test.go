...
func TestParseEnumsInFile(t *testing.T) {
...

	{
		...
		assert.Equal(t, "enums/enum.go", harvest.Typedefs[0].Filename)
		assert.Equal(t, "enums", harvest.Typedefs[0].PackageName)
		...
		assert.Equal(t, "enums/enum.go", harvest.Typedefs[1].Filename)
		assert.Equal(t, "enums", harvest.Typedefs[1].PackageName)
	}

	{
		...
		assert.Equal(t, "enums/enum.go", harvest.Enums[0].Filename)
		assert.Equal(t, "enums", harvest.Enums[0].PackageName)
		...
		assert.Equal(t, "enums/enum.go", harvest.Enums[1].Filename)
		assert.Equal(t, "enums", harvest.Enums[1].PackageName)
	}
}
